...
export function syncPolygonTarget87(graph, draft) {
    ...
    if (!draft && requested.get(drawing) === key) return false;
    requested.set(drawing, key);
    if (!draft && key && drawing.image && drawing.imageValue === key) return false;
